...
### 품사 통제
- **비율**: 명사 2 : 형용사/동사 1 (각 조건당 명사 32개 + 술어 16개)
- **술어 판정**: -하다, -다 등으로 끝나는 단어

### 친숙성≥3.5 단어 품사 분포

| 조건 | 총 | 명사 | 술어 | 명사 보충 | 술어 보충 |
|------|-----|------|------|----------|----------|
| Negative | 142 | 35 ✓ | 107 ✓ | 0 | 0 |
| Neutral | 20 | 9 | 11 | 23 | 5 |
| Positive | 48 | 18 | 30 ✓ | 14 | 0 |

### 선정 전략
1. **친숙성 ≥ 3.5** 단어 중 명사/술어 우선 포함
2. 부족분은 전체 풀(친숙성 정보 없는 단어)에서 보충
3. 수동으로 부적절한 단어 제외 (비표준어, 전문용어, 동음이의어 등)
4. 최종 각 조건 48개씩 선정 (명사 32 + 술어 16)

### 제한점
- Neutral: 친숙성 통제된 단어 20개뿐 → 28개는 전체 풀에서 선정
- Positive: 친숙성 통제된 명사 18개뿐 → 14개는 전체 풀에서 선정
