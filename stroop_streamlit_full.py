    ...
    if not st.session_state.practice_instructions_shown:
        ...
        instruction_pages = [
            {
                "lines": [
                    ...
                    "<span style='color: #888; font-size: 0.85em; display: inline-block; margin-top: 20px;'>마우스 커서는 화면 밖으로 이동해주세요.</span>"
                ],
                "button": "다음"
            },
            {
                "lines": [
                    "글자의 색깔이 <span style='color: red;'>빨간색</span>이면 <span style='color: red; font-weight: bold;'>F키</span>, <span style='color: lime;'>초록색</span>이면 <span style='color: lime; font-weight: bold;'>J키</span>를 눌러주세요."
                ],
                "button": "다음"
            },
            {
        ...
        if current_page == 1:
            ...
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;
                ...
                <p style="font-size: 26px; margin-bottom: 20px; line-height: 1.6; color: white;">{page["lines"][0]}</p>
...
if st.session_state.trial_num < len(st.session_state.exp_trials):
    ...
    if st.session_state.show_block_key_reminder:
        ...
        <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;
            ...
            <p style="font-size: 26px; margin-bottom: 30px; color: white;">글자의 색깔이 <span style='color: red;'>빨간색</span>이면 <span style='color: red; font-weight: bold;'>F키</span>, <span style='color: lime;'>초록색</span>이면 <span style='color: lime; font-weight: bold;'>J키</span>를 눌러주세요.</p>
            <div style="display: flex; gap: 80px; margin-bottom: 40px;">
                <div style="text-align: center;">
                    <div style="font-size: 64px; font-weight: bold; color: red;">F</div>
                    <div style="font-size: 32px; margin-top: 15px; color: red;">빨강</div>
